  ...
  return (
    <WithoutSessionLayout>
      <Container>
        ...
        <h2 className='mt30 mb30'>第3条（個人情報を収集・利用する目的）</h2>
        ...
        上記の利用目的に付随する目的
        <h2 className='mt30 mb30'>第4条（利用目的の変更）</h2>
        ...
        <h2 className='mt30 mb30'>第5条（個人情報の第三者提供）</h2>
        ...
        <h2 className='mt30 mb30'>第6条（個人情報の開示）</h2>
        ...
        <h2 className='mt30 mb30'>第7条（個人情報の訂正および削除）</h2>
        ...
        <h2 className='mt30 mb30'>第8条（個人情報の利用停止等）</h2>
        ...
        <h2 className='mt30 mb30'>第9条（プライバシーポリシーの変更）</h2>
