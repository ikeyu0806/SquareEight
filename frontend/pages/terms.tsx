    ...
    <WithoutSessionLayout>
      <Container>
        <Card>
          <Card.Body>
            <h3>利用規約</h3>
            この利用規約（以下，「本規約」といいます。）は，SquareEight（以下，「当サービス」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。

            <h4 className='mt30 mb30'>第1条（適用）</h4>
            ...
            <h4 className='mt30 mb30'>第2条（利用登録）</h4>
            ...
            <h4 className='mt30 mb30'>第3条（ユーザーIDおよびパスワードの管理）</h4>
            ...
            <h4 className='mt30 mb30'>第6条（本サービスの提供の停止等）</h4>
            ...
            <h4 className='mt30 mb30'>第7条（利用制限および登録抹消）</h4>
            ...
            <h4 className='mt30 mb30'>第8条（退会）</h4>
            ユーザーは，当サービスの定める退会手続により，本サービスから退会できるものとします。

            <h4 className='mt30 mb30'>第9条（保証の否認および免責事項）</h4>
            ...
            <h4 className='mt30 mb30'>第10条（サービス内容の変更等）</h4>
            当サービスは，ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。

            <h4 className='mt30 mb30'>第11条（利用規約の変更）</h4>
            ...
            <h4 className='mt30 mb30'>第12条（個人情報の取扱い）</h4>
            当サービスは，本サービスの利用によって取得する個人情報については，当サービス「プライバシーポリシー」に従い適切に取り扱うものとします。

            <h4 className='mt30 mb30'>第13条（通知または連絡）</h4>
            ...
            <h4 className='mt30 mb30'>第14条（権利義務の譲渡の禁止）</h4>
            ユーザーは，当サービスの書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。

            <h4 className='mt30 mb30'>第15条（準拠法・裁判管轄）</h4>
