      ...
      <Container>
        <Card>
          <Card.Body>
            ...
            <h4 className='mt30 mb30'></h4>第3条（ユーザーIDおよびパスワードの管理）
            ...
            <h4 className='mt30 mb30'></h4>第6条（本サービスの提供の停止等）
            ...
            <h4 className='mt30 mb30'></h4>第7条（利用制限および登録抹消）
            ...
            <h4 className='mt30 mb30'></h4>第8条（退会）
            ユーザーは，当サービスの定める退会手続により，本サービスから退会できるものとします。

            <h4 className='mt30 mb30'></h4>第9条（保証の否認および免責事項）
            ...
            <h4 className='mt30 mb30'></h4>第10条（サービス内容の変更等）
            当サービスは，ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。

            <h4 className='mt30 mb30'></h4>第11条（利用規約の変更）
            ...
            <h4 className='mt30 mb30'></h4>第12条（個人情報の取扱い）
            当サービスは，本サービスの利用によって取得する個人情報については，当サービス「プライバシーポリシー」に従い適切に取り扱うものとします。

            <h4 className='mt30 mb30'></h4>第13条（通知または連絡）
            ...
            <h4 className='mt30 mb30'></h4>第14条（権利義務の譲渡の禁止）
            ユーザーは，当サービスの書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。

            <h4 className='mt30 mb30'></h4>第15条（準拠法・裁判管轄）
