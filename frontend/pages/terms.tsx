  ...
  return (
    <WithoutSessionLayout>
      <Container>
        ...
        <h2 className='mt30 mb30'>第1条（適用）</h2>
        ...
        <h2 className='mt30 mb30'></h2>第3条（ユーザーIDおよびパスワードの管理）
        ...
        <h2 className='mt30 mb30'></h2>第6条（本サービスの提供の停止等）
        ...
        <h2 className='mt30 mb30'></h2>第7条（利用制限および登録抹消）
        ...
        <h2 className='mt30 mb30'></h2>第8条（退会）
        ユーザーは，当サービスの定める退会手続により，本サービスから退会できるものとします。

        <h2 className='mt30 mb30'></h2>第9条（保証の否認および免責事項）
        ...
        <h2 className='mt30 mb30'></h2>第10条（サービス内容の変更等）
        当サービスは，ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。

        <h2 className='mt30 mb30'></h2>第11条（利用規約の変更）
        ...
        <h2 className='mt30 mb30'></h2>第12条（個人情報の取扱い）
        当サービスは，本サービスの利用によって取得する個人情報については，当サービス「プライバシーポリシー」に従い適切に取り扱うものとします。

        <h2 className='mt30 mb30'></h2>第13条（通知または連絡）
        ...
        <h2 className='mt30 mb30'></h2>第14条（権利義務の譲渡の禁止）
        ユーザーは，当サービスの書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。

        <h2 className='mt30 mb30'></h2>第15条（準拠法・裁判管轄）
