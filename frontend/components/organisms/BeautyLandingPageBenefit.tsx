...
const BeautyLandingPageBenefit = (): JSX.Element => {
  return (
    <>
        ...
        <Col lg={6}>
          <div className={homeStyles.benefit_box}>
            ...
            <div className={homeStyles.benefit_text}>
              <br />他社予約サービスではスタンダードプランで月額料金数万以上、予約ごとに3000円請求など高額な運用費用がかかります。
              <br /><br />当サービスは有料プラン{lightPlanPrice}円〜ご利用可能！
            </div>
          </div>
        </Col>
        <Col lg={6}>
        ...
        <Col lg={6}>
          <div className={homeStyles.benefit_box}>
            ...
            <div className={homeStyles.benefit_text}>
              ...
              <br /><br />サロンビジネスの売り上げ安定化に効果的です。<br /><br />
            </div>
          </div>
        </Col>
      </Row>
      ...
      <Row>
        <Col lg={6} className='mb20'>
          <div className={homeStyles.benefit_box}>
            ...
            <div className={homeStyles.benefit_text}>
              <br />顧客にアンケートやメルマガ、LINEメッセージでアフターフォローできます。
              <br /><br /><br />
            </div>
          </div>
        </Col>
...
export default BeautyLandingPageBenefit
