  ...
  useEffect(() => {
    const fetchReserveFrame = () => {
      ...
      .then(function (response) {
        ...
        dispatch(outOfRangeFramesChanged(response.data.reserve_frame.out_of_range_frames_dates))
        dispatch(unreservableFramesChanged(response.data.reserve_frame.unreservable_frames_dates))
