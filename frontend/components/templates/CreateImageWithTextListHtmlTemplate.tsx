...
const CreateImageWithTextListHtmlTemplate = (): JSX.Element => {
  ...
  const addTemplateContent = () => {
    ...
    additionalHtmlMailTemplate = { text: draftText, image: base64Image, blockID: blockID, sortOrder: currentMaxSortOrder + 1 }
  ...
  return (
    <>
      {htmlMailTemplate.content && htmlMailTemplate.content.map((c, i) => {
          return [
            <Row key={i}>
              <Col>
                <img
...
export default CreateImageWithTextListHtmlTemplate
