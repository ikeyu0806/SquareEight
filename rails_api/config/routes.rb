Rails.application.routes.draw do
  ...
  namespace :api do
    namespace :batch do
      ...
      post 'send_line_schedules/send_same_hour_schedules', to: 'send_line_schedules#send_same_hour_schedules'
    end
    namespace :v1 do
      namespace :line do
    ...
    namespace :internal do
      ...
      get 'merchant_users/logged_in_merchant_user_detail', to: 'merchant_users#logged_in_merchant_user_detail'
      ...
      get 'customers/:public_id', to: 'customers#show'
      ...
      post 'customer_inquiry', to: 'customer_inquiry#send_confirm_mail'
      ...
      post 'products/:public_id/inventory_replenishment', to: 'products#inventory_replenishment'
      delete 'products/:public_id', to: 'products#logical_delete'
      get 'ticket_masters/related_data', to: 'ticket_masters#related_data'
      ...
      get 'resources/:public_id', to: 'resources#show'
      ...
      delete 'system_account_notifications/:public_id', to: 'system_account_notifications#destroy'
      get 'end_user_notifications/:public_id', to: 'end_user_notifications#show'
      ...
      delete 'system_end_user_notifications/:public_id', to: 'system_end_user_notifications#destroy'
      ...
      post 'send_mail_schedules/:public_id/cancel', to: 'send_mail_schedules#cancel'
      post 'send_mail_schedules', to: 'send_mail_schedules#create'
      get 'send_line_histories', to: 'send_line_histories#index'
      get 'send_line_schedules', to: 'send_line_schedules#index'
      post 'send_line_schedules/:public_id/cancel', to: 'send_line_schedules#cancel'
