    ...
    if reservation.payment_method == 'monthlyPaymentPlan'
      ...
      unless monthly_payment_plan.reserve_is_unlimited?
        ...
        target_day_reservation_count_before = self.reservations
          .monthly_subscription_range_reservations(this_day, 'front', monthly_payment_plan.id)
          .count
        target_day_reservation_count_after = self.reservations
          .monthly_subscription_range_reservations(this_day, 'back', monthly_payment_plan.id)
          .count
