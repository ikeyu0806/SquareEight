    ...
    cart_products.each do |cart|
      ...
      if merge_destination_item.blank?
        ...
        cart_items.push({
          ...
          image1_account_s3_image_public_url: product.main_image_public_url,
    ...
    cart_ticket_masters.each do |cart|
      ...
      if merge_destination_item.blank?
        cart_items.push({
          ...
          quantity: cart.quantity,
          image1_account_s3_image_public_url: cart.ticket_master.main_image_public_url,
    ...
    cart_monthly_payment_plans.each do |cart|
      ...
      if merge_destination_item.blank?
        cart_items.push({
          ...
          price: cart.monthly_payment_plan.price,
          image1_account_s3_image_public_url: cart.monthly_payment_plan.main_image_public_url,
          business_name: cart.account.business_name,
