  ...
  def create
    ActiveRecord::Base.transaction do
      ...
      if monthly_payment_plan_params[:base64_image].present?
        ...
        account_image.image1_account_s3_image_public_url = put_s3_http_request_base64_data(monthly_payment_plan_params[:base64_image], ENV["PRODUCT_IMAGE_BUCKET"], file_name)
