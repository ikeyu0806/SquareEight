  ...
  [
    {
      ...
      image1_account_s3_image_id: yoga_mat_image1.id,
      image2_account_s3_image_id: yoga_mat_image1.id,
      image3_account_s3_image_id: yoga_mat_image1.id,
      image4_account_s3_image_id: yoga_mat_image1.id,
      image5_account_s3_image_id: yoga_mat_image1.id,
    },
    {
      account_id: account.id,
      name: "ゴルフシュミレーター",
      ...
      resource_type: 'Equipment',
      is_show_reserve_page: true,
      image1_account_s3_image_id: gold_simulation_image1.id,
      image2_account_s3_image_id: gold_simulation_image1.id,
      image3_account_s3_image_id: gold_simulation_image1.id,
      image4_account_s3_image_id: gold_simulation_image1.id,
      image5_account_s3_image_id: gold_simulation_image1.id,
    },
    {
      account_id: account.id,
      name: "アウトドアテニスコート",
      ...
      resource_type: 'Equipment',
      is_show_reserve_page: true,
      image1_account_s3_image_id: outdoor_tennis_court_image1.id,
      image2_account_s3_image_id: outdoor_tennis_court_image1.id,
      image3_account_s3_image_id: outdoor_tennis_court_image1.id,
      image4_account_s3_image_id: outdoor_tennis_court_image1.id,
      image5_account_s3_image_id: outdoor_tennis_court_image1.id,
    },
    {
      account_id: account.id,
      name: "個室サウナ",
      ...
      resource_type: 'Equipment',
      is_show_reserve_page: true,
      image1_account_s3_image_id: personal_souna_image1.id,
      image2_account_s3_image_id: personal_souna_image1.id,
      image3_account_s3_image_id: personal_souna_image1.id,
      image4_account_s3_image_id: personal_souna_image1.id,
      image5_account_s3_image_id: personal_souna_image1.id,
    },
    {
      account_id: account.id,
      name: "デモスタッフ",
      ...
      resource_type: 'Staff',
      is_show_reserve_page: true,
      image1_account_s3_image_id: haircut_image1.id,
      image2_account_s3_image_id: haircut_image1.id,
      image3_account_s3_image_id: haircut_image1.id,
      image4_account_s3_image_id: haircut_image1.id,
      image5_account_s3_image_id: haircut_image1.id,
    },
    {
      account_id: account.id,
      name: "デモスタッフ",
    ...
    },
    {
      ...
      resource_type: 'Staff',
      is_show_reserve_page: true,
      image1_account_s3_image_id: personal_trainer_image1.id,
      image2_account_s3_image_id: personal_trainer_image1.id,
      image3_account_s3_image_id: personal_trainer_image1.id,
      image4_account_s3_image_id: personal_trainer_image1.id,
      image5_account_s3_image_id: personal_trainer_image1.id,
    },
    {
      account_id: account.id,
      name: "デモスタッフ",
