...
exports.handler = (event, context, callback) => {
  ...
  } else if (event.batch_type == 'exec_merchant_subscription_payment') {
    path = process.env.EXEC_MERCHANT_SUBSCRIPTION_PAYMENT_PATH
  } else if (event.batch_type == 'exec_system_subscription_payment') {
    path = process.env.EXEC_SYSTEM_SUBSCRIPTION_PAYMENT_PATH
  }
